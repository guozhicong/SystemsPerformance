...
| 硬件   | 配置                                                         | 查询命令                                                     |
| ------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 服务器 | Product Name: TaiShan 200 (Model 2280)                       | dmidecode -t 1 # 显示服务器厂商、型号、序列号等；  <br>dmidecode -s system-manufacturer   # 显示服务器厂商，比如宝德PowerLeader<br/>cat /sys/devices/virtual/dmi/id/sys_vendor<br/>dmidecode -s system-product-name  <br/>cat /sys/devices/virtual/dmi/id/product_name <br/>dmidecode -s system-serial-number |
...
| 网络   | lspci                                                        | grep -i ethernet 或者 lspci                                  |
